...
| `DEC-006` | Kaspa execution model | Singleton control/reserve L1 covenant family for the Testnet-10 PoC; production sharding deferred | Gio | Approved 2026-08-16 (`ADR-042`) |
