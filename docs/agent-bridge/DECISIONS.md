...
| `DEC-007` | Autonomous control model | Immutable economic core + bounded timelocked governance + progressive privilege removal + expiring pause-only Guardian; community mandate deferred | Gio | Proposed 2026-08-16 (`ADR-043` / #127); decision and all implementation remain pending |
