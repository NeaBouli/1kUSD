...
| `DEC-006` | Kaspa execution model | L1 covenant family / based app / hybrid | Gio after ADR | Open — singleton control/reserve L1 PoC proposed in `ADR-042`; production sharding deferred |
