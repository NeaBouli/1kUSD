...
echo "== DEV-10 06: add DEV10_Status_Integrations_r1.md =="

DOC_DIR="docs/dev"
DOC_FILE="${DOC_DIR}/DEV10_Status_Integrations_r1.md"
...
echo "[DEV-10 06] ${timestamp} Added DEV10_Status_Integrations_r1.md summarising DEV-10 work" >> "$LOG_FILE"
