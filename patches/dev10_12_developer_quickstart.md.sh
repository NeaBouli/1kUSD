...
echo "== DEV-10 12: add Developer Quickstart guide =="

DOC_FILE="docs/dev/DEV_Developer_Quickstart.md"
...
LOG_FILE="logs/project.log"
timestamp="$(date -u +"%Y-%m-%dT%H:%M:%SZ")"
echo "[DEV-10 12] ${timestamp} Added DEV_Developer_Quickstart.md for new contributors" >> "$LOG_FILE"
