...
path = root / "ARCHITECT_OracleRequired_OperationsBundle_v051_r1.md"

content = """# OracleRequired Operations Bundle (v0.51, r1)
...
needle = "- [ARCHITECT_BULLETIN_OracleRequired_Impact_v2](ARCHITECT_BULLETIN_OracleRequired_Impact_v2.md)"
insert = """- [ARCHITECT_BULLETIN_OracleRequired_Impact_v2](ARCHITECT_BULLETIN_OracleRequired_Impact_v2.md) – Architect bulletin describing OracleRequired as root safety layer and its impact on PSM/BuybackVault.
...
if "ARCHITECT_OracleRequired_OperationsBundle_v051_r1" not in text and needle in text:
    text = text.replace(needle, insert)

path.write_text(text, encoding="utf-8")
PY

echo "[DEV-11] $(date -u +"%Y-%m-%dT%H:%M:%SZ") define OracleRequired Operations Bundle v0.51 (architect report)" >> logs/project.log

echo "== DEV-11 PhaseB step01: OracleRequired Operations Bundle doc created and indexed =="
