...
plan_path = Path("docs/governance/DEV12_Governance_Docs_Plan_r1.md")
...
index_path = Path("docs/governance/index.md")
...
marker = "DEV-12 – Governance documentation plan"
link_line = "- [DEV-12 – Governance documentation plan](DEV12_Governance_Docs_Plan_r1.md)"

if marker not in text and "DEV12_Governance_Docs_Plan_r1.md" not in text:
    if not text:
        text = (
            "# Governance\n\n"
            "This section collects governance-related documentation for 1kUSD.\n\n"
            "## Documents\n\n"
            f"{link_line}\n"
        )
    else:
...
echo "[DEV-12] $(date -u +"%Y-%m-%dT%H:%M:%SZ") add governance docs plan and link from governance index" >> logs/project.log

echo "== DEV-12 step01: governance docs plan created and indexed =="
