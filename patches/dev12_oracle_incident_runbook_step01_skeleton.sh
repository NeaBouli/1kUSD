...
# DEV-12: OracleRequired Incident Runbook v0.51.x (r1)

cd "$(dirname "$0")/.."

FILE="docs/governance/GOV_OracleRequired_Incident_Runbook_v051_r1.md"
mkdir -p "$(dirname "$FILE")"

python3 - << 'PY'
from pathlib import Path

path = Path("docs/governance/GOV_OracleRequired_Incident_Runbook_v051_r1.md")
...
print("GOV_OracleRequired_Incident_Runbook_v051_r1.md written.")
PY

echo "[DEV-12] $(date -u +"%Y-%m-%dT%H:%M:%SZ") add OracleRequired incident runbook v051 r1" >> logs/project.log
echo "== DEV-12 step01: OracleRequired incident runbook v051 r1 written =="
