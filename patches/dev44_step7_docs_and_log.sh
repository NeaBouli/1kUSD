...
sed -i '' 's/## DEV-44 — PSM Price Normalization & Limits Math (planned)/## DEV-44 — PSM Price Normalization & Limits Math (price math complete, flows follow in DEV-45)/' docs/STATUS.md || true
