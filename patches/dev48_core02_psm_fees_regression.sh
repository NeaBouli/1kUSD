...
FILE="foundry/test/psm/PSMRegression_Fees.t.sol"

echo "== DEV48 CORE02: add PSMRegression_Fees (registry-driven mint/redeem fees) =="
...
echo "✓ PSMRegression_Fees written to $FILE"
