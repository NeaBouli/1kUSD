...
DOC="docs/governance/parameter_howto.md"
LOG="logs/project.log"

echo "== DEV58 DOC01: write Governance Parameter How-To (DE) =="

mkdir -p "$(dirname "$DOC")" "$(dirname "$LOG")"
...
printf "[DEV-58] %s Governance How-To (parameter_howto.md) written and linked to existing playbook\n" "$(date -u +"%Y-%m-%dT%H:%M:%SZ")" >> "$LOG"

echo "✓ Governance Parameter How-To written to $DOC and log updated."
