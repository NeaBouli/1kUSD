...
echo "== DEV77 REP01: write StrategyEnforcement mini-report =="

REPORT="docs/reports/DEV74-76_StrategyEnforcement_Report.md"
...
echo "[DEV-77] ${timestamp} Economic Layer: DEV74–76 StrategyEnforcement mini-report added (DEV74-76_StrategyEnforcement_Report.md)." >> "$LOG_FILE"
echo "✓ Report written to $REPORT"
echo "✓ Log updated at $LOG_FILE"
echo "== DEV77 REP01: done =="
