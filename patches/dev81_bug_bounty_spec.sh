...
# DEV-81: Bug Bounty Program for 1kUSD Economic Layer v0.51.0

mkdir -p docs/security logs

cat > docs/security/bug_bounty.md <<'EOD'
...
echo "$(date -u +"%Y-%m-%dT%H:%M:%SZ") DEV-81 add bug bounty specification for Economic Layer v0.51.0" >> logs/project.log
