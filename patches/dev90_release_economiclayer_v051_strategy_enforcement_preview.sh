...
echo "== DEV90 REL01: write Economic Layer v0.51.0 + StrategyEnforcement preview release note =="

FILE="docs/releases/EconomicLayer_v051_StrategyEnforcement_Preview.md"
...
echo "[DEV-90] ${timestamp} Releases: added EconomicLayer_v051 StrategyEnforcement preview release note." >> "$LOG_FILE"

echo "✓ Release note written to $FILE"
echo "✓ Log updated at $LOG_FILE"
echo "== DEV90 REL01: done =="
