...
DOC="docs/logs/DEV94_Release_Tag_Checks_Plan.md"
LOG_FILE="logs/project.log"

echo "== DEV94 REP01: write Release-Tag Checks plan =="
...
echo "[DEV-94] ${timestamp} Infra: added DEV94_Release_Tag_Checks_Plan.md (plan for future release-tag CI checks)." >> "$LOG_FILE"

echo "✓ Release-Tag Checks plan written to $DOC"
