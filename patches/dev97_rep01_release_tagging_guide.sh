...
REPORT="docs/logs/RELEASE_TAGGING_GUIDE_v0.51.x.md"
...
echo "[DEV-97] ${timestamp} Release: added manual release tagging guide (RELEASE_TAGGING_GUIDE_v0.51.x.md)." >> "$LOG_FILE"

echo "✓ Release tagging guide written to $REPORT"
echo "✓ Log updated at $LOG_FILE"
echo "== DEV97 REP01: done =="
