...
echo "== DEV-9 01: Create DEV9_Onboarding.md =="

# 1) Create docs/dev directory if missing
mkdir -p docs/dev

# 2) Write onboarding document
cat <<'EOD' > docs/dev/DEV9_Onboarding.md
...
echo "[DEV-9 01] ${timestamp} Added DEV9_Onboarding.md" >> "$LOG_FILE"
