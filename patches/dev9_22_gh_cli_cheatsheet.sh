...
echo "== DEV-9 22: add GH CLI cheatsheet for CI/workflows =="

mkdir -p docs/dev

cat <<'MD' > docs/dev/DEV9_GH_CLI_CheatSheet.md
...
echo "[DEV-9 22] ${timestamp} Added DEV9_GH_CLI_CheatSheet.md" >> "$LOG_FILE"
